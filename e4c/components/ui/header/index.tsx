        ...
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 ">
          <div className="relative flex h-20 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              <button
                type="button"
                className="relative inline-flex items-center justify-center rounded-md border border-gray-400  p-2 text-gray-400 hover:bg-light-blue-200 hover:border-light-blue-200 hover:text-white "
                ...
                <div className="flex space-x-6">
                  {navItems.map((item, index) => (
                    <Link
                      ...
                      href={item.url}
                      className={clsx(
                        "text-gray-500 hover:bg-light-blue-200  rounded-md px-3 py-2 text-md font-medium",
                        {
                          "bg-light-blue-200 text-white": pathname === item.url,
                        }
                      )}
                    >
                      {item.name}
        ...
        >
          {navItems.map((item, index) => (
            <Link
              ...
              onClick={handleOpen}
              href={item.url}
              className="text-gray-500 hover:bg-light-blue-200 hover:text-white block rounded-md px-3 py-2 text-base font-medium"
            >
              {item.name}
            </Link>
          ))}
          {user ? (
            <div
              ...
              className="relative text-gray-500 hover:bg-light-blue-200 hover:text-white block rounded-md px-3 py-2 text-base font-medium cursor-pointer"
            >
              <p>
                Trang cá nhân{" "}
                {openUser ? (
