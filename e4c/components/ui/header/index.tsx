                ...
                <div className="flex space-x-6">
                  {navItems.map((item, index) => (
                    <Link
                      ...
                      href={item.url}
                      className={clsx(
                        "text-gray-500 hover:bg-blue-200  rounded-md px-3 py-2 text-md font-medium",
                        {
        ...
        >
          {navItems.map((item, index) => (
            <Link
              ...
              onClick={handleOpen}
              href={item.url}
              className="text-gray-500 hover:bg-blue-200 hover:text-white block rounded-md px-3 py-2 text-base font-medium"
            >
              {item.name}
            </Link>
          ))}
          {user ? (
            <div
              ...
              className="relative text-gray-500 hover:bg-blue-200 hover:text-white block rounded-md px-3 py-2 text-base font-medium cursor-pointer"
            >
              <p>
                Trang cá nhân{" "}
                {openUser ? (
